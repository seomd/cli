...
export async function writeAnalysisToSeoMd(doc, response, cwd) {
    ...
    doc.setIn(['aeo', '_analysis', 'source'], 'gapmeter');
    ...
    doc.setIn(['intent', '_analysis', 'source'], 'gapmeter');
    ...
    doc.setIn(['pages', '_analysis', 'source'], 'gapmeter');
    ...
    doc.setIn(['keywords', '_analysis', 'source'], 'gapmeter');
...
#
# This file is generated by the GapMeter platform.
